...
class X2tLibsXML:
    ...
    def create_doc_renderer_config(self) -> None:
        """
        Creates the document renderer configuration XML file.
        :return: Path to the created XML file.
        """
        self._create(self._generate_doc_renderer_config(), xml_path=join(self.x2t_dir, 'DoctRenderer.config'))
    ...
    def _generate_doc_renderer_config(self) -> ET.Element:
        """
